...
import { getAuth, signInWithCredential, signInWithEmailAndPassword, GoogleAuthProvider, FacebookAuthProvider, signInWithPopup } from "@firebase/auth";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.password_container}>
        ...
        <TouchableOpacity onPress={togglePasswordVisibility}>
          <Icon name={isPasswordVisible ? 'eye' : 'eye-slash'}
            size={20}
            // style={{ left: 300 }}
            color='#f0e3e0' />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.loginButtonText}>
            <Image style={{
              ...
              height: 20,
              tintColor: 'white'
            }} source={{ uri: 'https://img.icons8.com/ios-filled/50/null/google-logo.png' }} />
            Google</Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <Text style={styles.loginButtonText}>
            <Image style={{
              ...
              source={{ uri: 'https://img.icons8.com/material-sharp/24/null/facebook-f.png' }} />
            Facebook</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.signUp_container}>
        <Text style={styles.registerButtonText1}>Don't have an account?
          <Text style={styles.registerButtonText2} onPress={() => {
